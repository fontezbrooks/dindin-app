...
To access the [`navigation.navigate`](https://reactnavigation.org/docs/navigation-object/#navigate), import the `navigation` prop from [`useNavigation`](https://docs.expo.dev/router/reference/hooks#usenavigation) hook.
